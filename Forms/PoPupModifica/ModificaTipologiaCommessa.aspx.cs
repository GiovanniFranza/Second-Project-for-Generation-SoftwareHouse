...
public partial class Forms_PoPupModifica_ModificaTipologiaCommessa : System.Web.UI.Page
{
    ...
    {
        TIPOLOGIECOMMESSA tcm = new TIPOLOGIECOMMESSA();//creo l'oggetto t di tipospesa
        ...
        dt = tcm.Select(codice);

        //di questo datatable prendimi alla riga X il contenuto di Y {MATRICE}
        txtCommessa.Text = dt.Rows[0]["Descrizione"].ToString();

    }

    protected void btnModifica_Click(object sender, EventArgs e)
    {
        int codiceCommessa = Convert.ToInt32(Session["id"]);
